  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      <header className="border-b border-zinc-800 bg-zinc-900/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-0 justify-between">
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            <h1 className="text-lg sm:text-xl font-bold text-white">Watch Party</h1>
            ...
            {isTVEpisode && roomState.isHost && (
              <div className="flex flex-wrap items-center justify-center gap-3">
                <Link
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all ${hasPrevBtn ? "bg-white text-zinc-900 hover:bg-zinc-200 hover:scale-105 active:scale-95" : "bg-zinc-800 text-zinc-600 cursor-not-allowed"}`}
                ...
                <Link
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all ${hasNextBtn ? "bg-white text-zinc-900 hover:bg-zinc-200 hover:scale-105 active:scale-95" : "bg-zinc-800 text-zinc-600 cursor-not-allowed"}`}
